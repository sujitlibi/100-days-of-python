...
#
# random_number_0_and_1 = random.random()
# print(random_number_0_and_1)
#
...
# and then you can import variables or functions from that file
# just by using the import keyword.
#
# Random Floats
...
# This method may or may not include the upper bound depending on the rounding of
# the floating point number. So it's best represented as:
#
# a <= random.uniform(a,b) <= b
#
# So depending on if you want the upper bound included you will choose whether
# to use random.random() or random.uniform().
#
