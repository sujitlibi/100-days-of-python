...
# In this list comprehension exercise you will practice using list
# comprehension to filter out the even numbers from a series of numbers.
#
...
numbers = [int(stg) for stg in list_of_strings]
